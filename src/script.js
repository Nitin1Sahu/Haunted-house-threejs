...
const doorAmbientOcclusionTextures = textureLoader.load(
...
const doorMetalnessTextures = textureLoader.load(
  "/textures/door/metalness.jpg"
);
const doorRoughnessTextures = textureLoader.load(
...
const roof = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({ color: "#b35f01" })
);
roof.position.y = 3;
...
const graveMaterial = new THREE.MeshStandardMaterial({ color: "#b2b6b9" });
for (let i = 0; i < 50; i++) {
